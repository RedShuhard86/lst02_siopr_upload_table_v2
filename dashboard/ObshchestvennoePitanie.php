...
<head>
    ...
    <script>
        ...
        function _customSelectRenderItem(data, selectIndex, itemIndex) {
        ...
        }function showNumberOfSeatsAtCateringFacilities(dataSet) {
            ...
            renderChart(options);
        }function showNumberOfCateringFacilities(dataSet, tabs) {
            dataSet = parseDataFromString(dataSet);
            ...
            renderChart(options);
        }function showNewCatering(dataSet, tabs) {
            dataSet = parseDataFromString(dataSet);
            tabs = parseDataFromString(tabs);
            ...
            renderChart(options);
        }function showLicensesForAlcoholic(dataSet) {
            dataSet = parseDataFromString(dataSet);
            ...
            renderChart(options);
        }function showLifeCycle(dataSet, tabs) {
            dataSet = parseDataFromString(dataSet);
            tabs = parseDataFromString(tabs);
...
<div class="main-content">
    ...
    <img
            ...
            <td class="small-data-block" id="cafe_block">
                <div class="small-data-block__header-part " id=""><img
    src="data:image/png;base64,"
    alt=""></div>
<div class="small-data-block__text-part " id="">Сезонные кафе</div>
<div class="small-data-block__array">
    <img
            src="data:image/png;base64,"
            alt="">
    ...
    <img
            ...
            alt="">
                ...
                <table class="section__big-blocks-table">
                        ...
                        <td class="big-data-block" id="infoBlock1" colspan="3">
                            ...
                            <div class="big-data-block__header">
                                <table class="big-data-block__header-table">
                                    <tbody>
                                    <tr>
                                        <td class="big-data-block__header__text">Количество посадочных мест на предприятиях общественного питания (шт.)</td>
                        ...
                        <td class="big-data-block" id="infoBlock2">
                            ...
                            <div class="big-data-block__header">
                                <table class="big-data-block__header-table">
                                    <tbody>
                                    <tr>
                                        <td class="big-data-block__header__text">Наличие договоров на вывоз мусора у объектов общественного питания (%)</td>
                                        <td class="big-data-block__header__resize-button">
                            ...
                            <div class="big-data-block__content">
                                <div class="big-data-block__horizontal-chart  big-data-block__container " id="chart_2" style="overflow: hidden; height:300px "></div>
                                <a href="report/1056?variant=%D0%9E%D0%B1%D1%89%D0%B5%D0%BF%D0%B8%D1%82" target="_blank">
                        ...
                        <td class="big-data-block" id="infoBlock3">
                            ...
                            <div class="big-data-block__header">
                                <table class="big-data-block__header-table">
                                    <tbody>
                                    <tr>
                                        <td class="big-data-block__header__text">Количество объектов общественного питания  (шт. по округам)</td>
                                        <td class="big-data-block__header__resize-button">
                        ...
                        <td class="big-data-block" id="infoBlock4" colspan="3">
                            ...
                            <div class="big-data-block__header">
                                <table class="big-data-block__header-table">
                                    <tbody>
                                    <tr>
                                        <td class="big-data-block__header__text">Открытие новых предприятий общественного питания (шт. по районам)</td>
                                        <td class="big-data-block__header__resize-button">
                        ...
                        <td class="big-data-block" id="infoBlock5" colspan="3">
                            ...
                            <div class="big-data-block__header">
                                <table class="big-data-block__header-table">
                                    <tbody>
                                    <tr>
                                        <td class="big-data-block__header__text">Количество лицензий на алкогольную продукцию (шт.)</td>
                                        <td class="big-data-block__header__resize-button">
                    ...
                    <span>Список лицензий на алкогольную продукцию</span>
                        ...
                        <td class="big-data-block" id="infoBlock6" colspan="3">
                            ...
                            <div class="big-data-block__header">
                                <table class="big-data-block__header-table">
                                    <tbody>
                                    <tr>
                                        <td class="big-data-block__header__text">Жизненный цикл предприятий общественного питания (шт.)</td>
                                        <td class="big-data-block__header__resize-button">
...
<script language="JavaScript">
    ...
    function showDataFullnessOnline() {
        $.ajax({
            ...
            data: "wp=ObshchestvennoePitanie&func=getDataFullnessFromServer",
    ...
    }// 1) Количество посадочных мест на предприятиях общественного питания (шт.)
    function showNumberOfSeatsAtCateringFacilitiesOnline() {
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getNumberOfSeatsAtCateringFacilitiesFromServer",
            success: function(data) {
                ...
                for (let i = 0; i <  newData.series.length; i++) {
                    newData.series[i].color = color[indexColor]
                    for (let q = 0; q <  newData.series[i].data.length; q++) {
                        newData.series[i].data[q].color = color[indexColor]
                        if(color.length >  indexColor) {
                            indexColor++;
                        }
                    }
                }
                ...
                showNumberOfSeatsAtCateringFacilities(json);
            },
            error:  function(){
                alert('Ошибка получения данных для функции showNumberOfSeatsAtCateringFacilities');
            }
        });
    }// 2) Наличие договоров на вывоз мусор у объектов общественного питания (%)
    function showGarbageRemovalOnline() {
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getGarbageRemovalFromServer",
            success: function(data) {
                let newData = JSON.parse(data)
                let color = [
                    ["#1ee8a8", "#3cda50"],
                ...
                for (let i = 0; i <  newData.length; i++) {
                    newData[i].color = color[indexColor]
                    if(color.length >  indexColor) {
                        indexColor++;
                    }
                }
    ...
    }// 3) Количество объектов общественного питания (шт. по округам)
    function showNumberOfCateringFacilitiesOnline(btn) {
        var param = utf8_to_b64('btn1='+btn);
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getNumberOfCateringFacilitiesFromServer&param="+param,
            success: function(data) {
                ...
                var btnArr = ["chartButton1", "chartButton2", "chartButton3"];
                var nameArr = ["Все", "новые", "в жилых домах"];
                var tabs = [];
                for(var i = 0; i < btnArr.length; i++) {
                    if(btnArr[i] == btn) {
                        tabs[i] = {"name": nameArr[i], "buttonId": btnArr[i], "selected": "true"};
                    } else {
                        tabs[i] = {"name": nameArr[i], "buttonId": btnArr[i]};
                    }
                }
                var series = [{"name": "Количество", "data": datax[1], "color": collorsArr[0]}];
                JSONx = {"categories": datax[0], "series": series};
                showNumberOfCateringFacilities(JSONx, tabs);
            },
            error:  function(){
                alert('Ошибка получения данных для функции showNumberOfCateringFacilities');
            }
        });
    }// 4) Открытие новых предприятий общественного питания (шт. по районам) - 1 1
    function showNewCateringOnline(btn, btn1) {
        var param = utf8_to_b64('btn1='+btn+'&btn2='+btn1);
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getNewCateringFromServer&param="+param,
            success: function(data) {
                var JSONx;
                var datax = JSON.parse(data);
                var collorsArr = [
                ...
                var tabs_1 = [];
                var buttonId = "comboBoxItem_1_";
                var curBtn = buttonId+(i+1);
                for(var i=0; i < datax[1].length; i++) {
                    if(datax[0] == datax[1][i]) {
                        tabs_1[i] = {"text": datax[1][i], "buttonId": curBtn, "selected": "true"};
                    } else {
                        tabs_1[i] = {"text": datax[1][i], "buttonId": curBtn};
                    }
                }

                var periodsArr = ["с начала года", "с начала квартала", "с начала месяца", "с начала недели"];

                var tabs_2 = [];
                buttonId = "comboBoxItem_2_";
                for(var i=0; i < periodsArr.length; i++) {
                    curBtn = buttonId + (i+1);
                    if(curBtn == btn1) {
                        tabs_2[i] = {"text": periodsArr[i], "buttonId": curBtn, "selected": "true"};
                    } else {
                        tabs_2[i] = {"text": periodsArr[i], "buttonId": curBtn};
                    }
                }

                var tabs = [tabs_1, tabs_2];

                var areasArr = [];
                for(var i=0; i < datax[2].length; i++){
                    areasArr[i] = datax[2][i];
                }

                var series = [{"name": "Количество", "data": datax[3], "color":collorsArr[0]}];

                JSONx = {"categories": areasArr, "series": series};

                showNewCatering(JSONx, tabs);
            },
            error:  function(){
                alert('Ошибка получения данных для функции showNewCatering');
            }
        });
    }// 5) Количество лицензий на алкогольную продукцию (шт.)
    function showLicensesForAlcoholicOnline() {
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getLicensesForAlcoholicFromServer",
            success: function(data) {
                ...
                let json = JSON.stringify(newData)
                showLicensesForAlcoholic(json);
            },
            error:  function(){
                alert('Ошибка получения данных для функции showLicensesForAlcoholic');
            }
        });
    }// 6) Жизненный цикл предприятий общественного питания (шт.) - "comboBoxItem_3_1", "comboBoxItem_4_1"
    function showLifeCycleOnline(btn, btn1) {
        var param = utf8_to_b64('btn1='+btn+'&btn2='+btn1);
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getLifeCycleFromServer&param="+param,
            success: function(data) {
                var JSONx;
                var datax = JSON.parse(data);

                var datesArr = ["Начало этого дня", "Начало этой недели", "Начало этой декады", "Начало этого месяца", "Начало этого квартала", "Начало этого полугодия", "Начало этого года",
                    "Начало вчерашнего дня", "Начало прошлой недели", "Начало прошлой декады", "Начало прошлого месяца", "Начало прошлого квартала", "Начало прошлого полугодия", "Начало прошлого года",
                    "Начало завтрешнего дня", "Начало следующей недели", "Начало следующей декады", "Начало следующего месяца", "Начало следующего квартала", "Начало следующего полугодия", "Начало следующего года"];
                var timingsArr = ["Предприятия, действующие меньше года", "Предприятия, действующие от 1 до 3 лет", "Предприятия, действующие от 3 до 5 лет", "Предприятия, действующие свыше 5 лет"];
                var collorsArr = [
                    ['#1A78E2' , '#40B3EE'],
                ];

                var tabs_1 = [];
                var buttonId = "comboBoxItem_3_";
                var curBtn;
                for(var i=0; i < datesArr.length; i++) {
                    curBtn = buttonId + (i+1);
                    if(curBtn == btn) {
                        tabs_1[i] = {"text": datesArr[i], "buttonId": curBtn, "selected": "true"};
                    } else {
                        tabs_1[i] = {"text": datesArr[i], "buttonId": curBtn};
                    }
                }

                var tabs_2 = [];
                buttonId = "comboBoxItem_4_";
                for(var i=0; i < timingsArr.length; i++) {
                    curBtn = buttonId + (i+1);
                    if(curBtn == btn1) {
                        tabs_2[i] = {"text": timingsArr[i], "buttonId": curBtn, "selected": "true"};
                    } else {
                        tabs_2[i] = {"text": timingsArr[i], "buttonId": curBtn};
                    }
                }
                var tabs = [tabs_1, tabs_2];
                var series = [{"name": "Количество", "data": datax[1], "color":collorsArr[0]}];
                JSONx = {"categories": datax[0], "series": series};
                showLifeCycle(JSONx, tabs);
            },
            error:  function(){
                alert('Ошибка получения данных для функции showLifeCycle');
            }
        });
    ...
    function setActualDateOnline() {
        $.ajax({
            type: 'POST',
            url: 'selector_1s.php', // Обработчик собственно
            data: "wp=ObshchestvennoePitanie&func=getActualDate",
            success: function(data) {
                setActualDate(data);
            },
            error:  function(){
        ...
        showNumberOfSeatsAtCateringFacilitiesOnline();
        showGarbageRemovalOnline();
        showNumberOfCateringFacilitiesOnline("chartButton1");
        showNewCateringOnline("comboBoxItem_1_1", "comboBoxItem_2_1");
        showLicensesForAlcoholicOnline();
        showLifeCycleOnline("comboBoxItem_3_1", "comboBoxItem_4_1");
        setActualDateOnline();

        $(document).on('click', '#chart_3 [buttonid="chartButton1"]', function(event) {showNumberOfCateringFacilitiesOnline("chartButton1");});
        $(document).on('click', '#chart_3 [buttonid="chartButton2"]', function(event) {showNumberOfCateringFacilitiesOnline("chartButton2");});
        $(document).on('click', '#chart_3 [buttonid="chartButton3"]', function(event) {showNumberOfCateringFacilitiesOnline("chartButton3");});
        $(document).on('click', '#chart_4 #tabPanel_0 li, #chart_4 #tabPanel_1 li', function(event) {
            setTimeout(function(){
                var btnId1 = $('#chart_4 #tabPanel_0 li.tab-custom-select__list-item_selected').data('index') + 1;
                var btnId2 = $('#chart_4 #tabPanel_1 li.tab-custom-select__list-item_selected').data('index') + 1;
                showNewCateringOnline("comboBoxItem_1_"+btnId1, "comboBoxItem_2_1"+btnId2);
            }, 500);
        });
        $(document).on('click', '#chart_6 #tabPanel_0 li, #chart_6 #tabPanel_1 li', function(event) {
            setTimeout(function(){
                var btnId1 = $('#chart_6 #tabPanel_0 li.tab-custom-select__list-item_selected').data('index') + 1;
                var btnId2 = $('#chart_6 #tabPanel_1 li.tab-custom-select__list-item_selected').data('index') + 1;
                showLifeCycleOnline("comboBoxItem_3_"+btnId1, "comboBoxItem_4_"+btnId2);
            }, 500);
        });
    });
</script>
